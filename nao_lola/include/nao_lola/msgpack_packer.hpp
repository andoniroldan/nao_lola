...
public:
  ...
  void setJointStiffnesses(const nao_lola_command_msgs::msg::JointStiffnesses & jointStiffnesses);
  void setChestLed(const nao_lola_command_msgs::msg::ChestLed & chestLed);
  void setLeftEarLeds(const nao_lola_command_msgs::msg::LeftEarLeds & leftEarLeds);
  void setRightEarLeds(const nao_lola_command_msgs::msg::RightEarLeds & rightEarLeds);
  void setLeftEyeLeds(const nao_lola_command_msgs::msg::LeftEyeLeds & leftEyeLeds);
  void setRightEyeLeds(const nao_lola_command_msgs::msg::RightEyeLeds & rightEyeLeds);
  void setLeftFootLed(const nao_lola_command_msgs::msg::LeftFootLed & leftFootLed);
  void setRightFootLed(const nao_lola_command_msgs::msg::RightFootLed & rightFootLed);
...
private:
  ...
  std::array<float, static_cast<int>(nao_lola_command_msgs::msg::LeftEarLeds::NUM_LEDS)> l_ear;
  std::array<float, static_cast<int>(nao_lola_command_msgs::msg::RightEarLeds::NUM_LEDS)> r_ear;
  std::array<float, 3 * static_cast<int>(nao_lola_command_msgs::msg::LeftEyeLeds::NUM_LEDS)> l_eye;
  std::array<float, 3 * static_cast<int>(nao_lola_command_msgs::msg::RightEyeLeds::NUM_LEDS)> r_eye;
